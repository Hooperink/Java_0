...
public class StringValidator {
    ...
    public boolean validate(String toValidate) {
        ...
        Pattern patternVacationType = Pattern.compile("(\\s+|\\b+)Vacation type:.+;");
        Pattern patternTransport = Pattern.compile("(\\s+|\\b+)Transport:.+;");
        Pattern patternCountry = Pattern.compile("(\\s+|\\b+)Country:.+;");
        Pattern patternFoodType = Pattern.compile("(\\s+|\\b+)Food type:.+;");
